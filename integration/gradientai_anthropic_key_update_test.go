...
var _ = suite("gradient/anthropic-key/update", func(t *testing.T, when spec.G, it spec.S) {
	var (
	...
	when("valid anthropic key id is passed", func() {
		it("updates the anthropic key", func() {
	...
	when("invalid anthropic key id is passed", func() {
