...
const projectsResourcesGetDropletOutput = `
...
`
const projectsResourcesGetFloatingIPOutput = `
IP             Region    Droplet ID    Droplet Name
45.55.96.47    nyc3
`
const projectsResourcesGetFloatingIPResponse = `
{
  "floating_ip": {
    "ip": "45.55.96.47",
    "droplet": null,
...
`
const projectsResourcesGetLoadbalancerOutput = `
ID                                      IP                 Name             Status    Created At              Algorithm      Region    Tag    Droplet IDs    SSL      Sticky Sessions                                Health Check                                                                                                            Forwarding Rules
4de7ac8b-495b-4884-9a69-1050c6793cd6    104.131.186.241    example-lb-01    new       2017-02-01T22:22:58Z    round_robin    nyc3             3164445        false    type:none,cookie_name:,cookie_ttl_seconds:0    protocol:,port:0,path:,check_interval_seconds:0,response_timeout_seconds:0,healthy_threshold:0,unhealthy_threshold:0    entry_protocol:https,entry_port:444,target_protocol:https,target_port:443,certificate_id:,tls_passthrough:true
`
const projectsResourcesGetLoadbalancerResponse = `
{
  "load_balancer": {
...
`
const projectsResourcesGetDomainOutput = `
Domain         TTL
example.com    1800
`
const projectsResourcesGetDomainResponse = `
{
  "domain": {
    "name": "example.com",
    "ttl": 1800,
...
`
const projectsResourcesGetVolumeOutput = `
...
`
const projectsResourcesGetVolumeResponse = `
{
  "volume": {
