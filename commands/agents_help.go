...
const agentsTemplatesRootHelpMD = `Team custom sandbox templates. Create a template from your own OCI image rebased onto a platform base (` + "`coding-claude-code`" + `, ` + "`coding-codex`" + `, ` + "`coding-hermes`" + `, ` + "`coding-opencode`" + `, ` + "`langgraph`" + `). Create and update kick a build; use ` + "`list-builds`" + ` to watch it.
