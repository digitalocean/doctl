...
With the Partner Interconnect Attachments commands, you can get, list, create, update, or delete Partner Interconnect Attachments, and manage their configuration details.`,
	...
	AddIntFlag(cmdPartnerIACreate, doctl.ArgPartnerInterconnectAttachmentConnectionBandwithInMbps, "", 0, "Connection Bandwidth in Mbps", requiredOpt())
...
func RunPartnerInterconnectAttachmentCreate(c *CmdConfig) error {
	...
	connBandwidth, err := c.Doit.GetInt(c.NS, doctl.ArgPartnerInterconnectAttachmentConnectionBandwithInMbps)
	if err != nil {
		return err
	}
