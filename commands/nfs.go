...
doctl nfs list --region 'atl1' --format ID,Name,Size,Status`
	...
	AddWaitFlags(cmdNfsResize, false, "Wait for action to complete")
	...
	AddWaitFlags(cmdNfsAttach, false, "Wait for action to complete")
	...
	AddWaitFlags(cmdNfsDetach, false, "Wait for action to complete")
	...
	AddWaitFlags(cmdNfsReassign, false, "Wait for action to complete")
	...
	AddWaitFlags(cmdNfsSwitchPerformanceTier, false, "Wait for action to complete")
...
func nfsSnapshots() *Command {
	...
	AddWaitFlags(cmdNfsSnapshotCreate, false, "Wait for action to complete")
