...
func (mr *MockVPCsServiceMockRecorder) CreateVPCPeering(req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVPCsServiceMockRecorder) DeleteVPCPeering(peeringID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVPCsServiceMockRecorder) GetPeering(peeringID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVPCsServiceMockRecorder) ListVPCPeeringsByVPCID(vpcID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVPCsServiceMockRecorder) UpdateVPCPeering(peeringID, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
