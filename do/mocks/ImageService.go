...
func (mr *MockImagesServiceMockRecorder) Create(icr any) *gomock.Call {
...
func (mr *MockImagesServiceMockRecorder) Delete(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) GetByID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) GetBySlug(slug any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) List(public any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) ListApplication(public any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) ListDistribution(public any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) ListUser(public any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImagesServiceMockRecorder) Update(id, iur any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
