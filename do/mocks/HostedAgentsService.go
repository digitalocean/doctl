...
//
//	mockgen -source agents.go -package=mocks HostedAgentsService
//
...
func (m *MockHostedAgentsService) CreateAgentConfig(create *godo.HostedAgentConfigCreateRequest) (*godo.HostedAgentConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAgentConfig", create)
	ret0, _ := ret[0].(*godo.HostedAgentConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateAgentConfig indicates an expected call of CreateAgentConfig.
func (mr *MockHostedAgentsServiceMockRecorder) CreateAgentConfig(create any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAgentConfig", reflect.TypeOf((*MockHostedAgentsService)(nil).CreateAgentConfig), create)
}
...
// CreateSessionFromConfig mocks base method.
func (m *MockHostedAgentsService) CreateSessionFromConfig(create *godo.HostedAgentSessionFromConfigRequest) (*do.HostedAgentSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSessionFromConfig", create)
	ret0, _ := ret[0].(*do.HostedAgentSession)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateSessionFromConfig indicates an expected call of CreateSessionFromConfig.
func (mr *MockHostedAgentsServiceMockRecorder) CreateSessionFromConfig(create any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSessionFromConfig", reflect.TypeOf((*MockHostedAgentsService)(nil).CreateSessionFromConfig), create)
}
...
func (m *MockHostedAgentsService) DeleteAgentConfig(configID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAgentConfig", configID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAgentConfig indicates an expected call of DeleteAgentConfig.
func (mr *MockHostedAgentsServiceMockRecorder) DeleteAgentConfig(configID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAgentConfig", reflect.TypeOf((*MockHostedAgentsService)(nil).DeleteAgentConfig), configID)
}
...
func (m *MockHostedAgentsService) GetAgentConfig(configID string) (*godo.HostedAgentConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAgentConfig", configID)
	ret0, _ := ret[0].(*godo.HostedAgentConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockHostedAgentsServiceMockRecorder) GetAgentConfig(configID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAgentConfig", reflect.TypeOf((*MockHostedAgentsService)(nil).GetAgentConfig), configID)
}
...
// ListAgentConfigSessions mocks base method.
func (m *MockHostedAgentsService) ListAgentConfigSessions(configID string, opt *godo.HostedAgentSessionListOptions) ([]do.HostedAgentSession, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAgentConfigSessions", configID, opt)
	ret0, _ := ret[0].([]do.HostedAgentSession)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
// ListAgentConfigSessions indicates an expected call of ListAgentConfigSessions.
func (mr *MockHostedAgentsServiceMockRecorder) ListAgentConfigSessions(configID, opt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAgentConfigSessions", reflect.TypeOf((*MockHostedAgentsService)(nil).ListAgentConfigSessions), configID, opt)
}

// ListAgentConfigs mocks base method.
func (m *MockHostedAgentsService) ListAgentConfigs(opt *godo.HostedAgentConfigListOptions) ([]godo.HostedAgentConfigSummary, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAgentConfigs", opt)
	ret0, _ := ret[0].([]godo.HostedAgentConfigSummary)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (mr *MockHostedAgentsServiceMockRecorder) ListAgentConfigs(opt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAgentConfigs", reflect.TypeOf((*MockHostedAgentsService)(nil).ListAgentConfigs), opt)
}
