...
func (m *MockHostedAgentsService) PollProviderAuth(provider, pollURL string) (*do.HostedAgentProviderAuthPoll, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PollProviderAuth", provider, pollURL)
	ret0, _ := ret[0].(*do.HostedAgentProviderAuthPoll)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockHostedAgentsService) StartProviderAuth(provider string) (*do.HostedAgentProviderAuthStart, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartProviderAuth", provider)
	ret0, _ := ret[0].(*do.HostedAgentProviderAuthStart)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
