...
func (mr *MockPartnerAttachmentsServiceMockRecorder) Create(arg0 interface{}) *gomock.Call {
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) DeletePartnerAttachment(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) GetBGPAuthKey(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) GetPartnerAttachment(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) GetServiceKey(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) ListPartnerAttachmentRoutes(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) RegenerateServiceKey(paID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPartnerAttachmentsServiceMockRecorder) UpdatePartnerAttachment(paID, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
